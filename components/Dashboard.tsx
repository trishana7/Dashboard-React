      ...
      <div className="flex flex-wrap lg:flex-nowrap w-full gap-4">
        ...
        <div className="w-full lg:w-[35%] bg-white rounded-lg h-[199px] py-5 flex justify-around items-center px-5 2xl:pl-20">
          ...
          <div>
            ...
            <p className="text-gray-4 text-sm font-medium">Last 7 days</p>
            <p className="text-gray-3 font-bold text-32px mt-6">$350K</p>
            <div>
        ...
        <div className="w-full lg:w-[25%] bg-white rounded-lg h-[199px] p-5">
          <div className="flex">
            ...
            <div className="ml-4">
              <p className="text-lg font-semibold text-gray-3">Total Profit</p>
              <p className="text-gray-4 text-sm font-medium">Last 7 days</p>
            </div>
          </div>
          <p className="text-gray-3 font-bold text-32px mt-6">50K</p>
          <div>
            <Icon iconName="ProgressArrow" />
            ...
            >
              <div className="flex">
                <div className="ml-2 mr-4">
                  ...
                  <p className="text-gray-4 text-sm font-medium whitespace-nowrap w-20">
